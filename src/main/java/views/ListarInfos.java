...
//        this.cm = cm;
    ...
    private void initComponents() {
        ...
        tbInfos = new javax.swing.JTable();

        setMaximumSize(new java.awt.Dimension(839, 608));

        panelTabela.setBackground(new java.awt.Color(204, 204, 204));
        panelTabela.setMaximumSize(new java.awt.Dimension(839, 32767));
        ...
        tbInfos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Data", "Km Percorridos", "Litros Abastecidos", "Km Total", "Média (litros p/ km)"
            }
        ) {
        ...
        tbInfos.setToolTipText("");
        jScrollPane1.setViewportView(tbInfos);
    ...
    private javax.swing.JTable tbInfos;
